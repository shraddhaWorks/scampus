...
export const PRINCIPAL_MENU_ITEMS: SidebarItem[] = [
    {
        label: "Dashboard",
        tab: "dashboard",
        href: "/frontend/pages/principle?tab=dashboard",
        icon: LayoutDashboard,
        permission: Permission.DASHBOARD,
    },
    {
        label: "Add HOD",
        tab: "addHod",
        href: "/frontend/pages/principle?tab=addHod",
        icon: UserPlus,
        permission: Permission.ADD_HOD,
    },
    {
        label: "Add User",
        tab: "addUser",
        href: "/frontend/pages/principle?tab=addUser",
        icon: UserPlus,
        permission: Permission.NEW_USER,
    },
    {
        label: "Analysis",
        tab: "analysis",
        href: "/frontend/pages/principle?tab=analysis",
        icon: ChartColumn,
        permission: Permission.ANALYSIS,
    },
    {
        label: "Bus Booking",
        tab: "busBooking",
        href: "/frontend/pages/principle?tab=busBooking",
        icon: Briefcase,
        permission: Permission.BUS_BOOKING,
    },
    {
        label: "Certificates",
        tab: "certificates",
        href: "/frontend/pages/principle?tab=certificates",
        icon: AwardIcon,
        permission: Permission.CERTIFICATES,
    },
    {
        label: "Circulars",
        tab: "circular",
        href: "/frontend/pages/principle?tab=circular",
        icon: Scroll,
        permission: Permission.CIRCULARS,
    },
    {
        label: "Exam Syllabus",
        tab: "examSyllubus",
        href: "/frontend/pages/principle?tab=examSyllubus",
        icon: FileText,
    ...
    },
    {
        label: "Fees",
        tab: "fees",
        href: "/frontend/pages/principle?tab=fees",
        icon: DollarSign,
        permission: Permission.FEES,
    },
    {
        label: "HOD Leaves",
        tab: "hodLeaves",
        href: "/frontend/pages/principle?tab=hodLeaves",
        icon: FileText,
        permission: Permission.HOD_LEAVES,
    },
    {
        label: "Hostel Booking",
        tab: "hostelBooking",
        href: "/frontend/pages/principle?tab=hostelBooking",
        icon: House,
        permission: Permission.HOSTEL_BOOKING,
    },
    {
        label: "Library",
        tab: "library",
        href: "/frontend/pages/principle?tab=library",
        icon: BookOpen,
    ...
    },
    {
        label: "Marks",
        tab: "marks",
        href: "/frontend/pages/principle?tab=marks",
        icon: Award,
        permission: Permission.MARKS,
    },
    {
        label: "News Feed",
        tab: "newsFeed",
        href: "/frontend/pages/principle?tab=newsFeed",
        icon: Newspaper,
        permission: Permission.NEWSFEED,
    },
    {
        ...
        tab: "roomAllocation",
        href: "/frontend/pages/principle?tab=roomAllocation",
        icon: Layout,
    ...
    },
    {
        label: "Student Details",
        tab: "studentDetails",
        href: "/frontend/pages/principle?tab=studentDetails",
        icon: UserCheck,
        permission: Permission.STUDENT_DETAILS,
    },
    {
        label: "Teacher Attendance",
        tab: "teacherAttendennce",
        href: "/frontend/pages/principle?tab=teacherAttendennce",
        icon: Calendar,
    ...
    },
    {
        label: "Teacher Audit",
        tab: "teacherAudit",
        href: "/frontend/pages/principle?tab=teacherAudit",
        icon: Award,
        permission: Permission.TEACHER_AUDIT,
    },
    {
        label: "Time Table",
        tab: "timeTable",
        href: "/frontend/pages/principle?tab=timeTable",
        icon: CalendarClock,
    ...
    },
    {
        label: "Workshops",
        tab: "workShops",
        href: "/frontend/pages/principle?tab=workShops",
        icon: Briefcase,
        permission: Permission.WORKSHOPS,
    },
    {
        label: "Settings",
        tab: "settings",
        href: "/frontend/pages/principle?tab=settings",
        icon: Settings,
        permission: Permission.SETTINGS,
    },
    {
